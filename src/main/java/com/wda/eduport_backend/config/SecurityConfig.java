...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("https://eduport-admin.netlify.app","https://eduport-user.netlify.app","http://localhost:5173/","http://localhost:5174/")); // Allow your frontend origin
